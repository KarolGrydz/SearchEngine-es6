...
var variables = {
	...
	/*Rozdzielki 500V*/
	"rnn-11.1", "rnn-11.2 I", "rnn-12.1", "rnn-12.2 I", "rnn-13.1", "rnn-13.2 I", "rnn-13.2 II", "rnn-14.1", "rnn-14.2 II", "rnn-16.1", "rnn-16.2 I", "rnn-16.2 II", "rnn-17.1", "rnn-17.2 II", "rnn-4.3", "rg-wr warsztaty główne", "rg-1 magazyn odczynników", "irnn-3.3", "irnn-3.2", "iirnn-3.3", "iirnn-3.2", "rnn-10.1", "rmf-500V", "rmk-500V", "rp-51", "rpo-1.1", "rpo-1.2", "rpo-3.1", "rpo-3.2", "rpo-4.1", "rpo-4.2", "rzk-1", "rzk-1.1", "rzk-1.1.1", "rzk-1.2",
	...
	/*Schematy 230V*/
	/*Biurowiec*/
	"TG łącznik biurrowca", "ster. urządzeń palarni", "rki-1", "rki-2", "rki-3", "rob-1.1", "rob-1.2", "rob-1.3", "rob-1.4", "rob-1.5", "tk-1", "tk-2", "tk-3", "tk-4", "tk-5", "tk-6", "tk-7", "tk-8", "zasil. urządzeń palarni",
	/*Kwasy ROMF*/
	...
	/*Urządzenia*/
	/*6kV*/
	"mk-111", "mk-112", "mk-121", "mk-122", "mk-131", "mk-132", "md-113", "md-123", "md-133", "md-143", "ks-101", "mk-211", "mk-212", "mk-221", "mk-222", "mk-231", "mk-232", "md-213", "md-223", "md-233", "md-243", "ks-102", "mk-311", "mk-321", "mk-331", "mk-341", "md-313", "md-323", "md-333", "ks-301", "sf-4"]
};
...
function start() {
	return (0, _autocomplete.autocomplete)(searchEngine), (0, _logic.getSchemat)();
}
